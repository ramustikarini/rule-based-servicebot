...
with st.container(border=True):
    st.markdown('''I'm a service bot to help you get the information need regarding our dental clinic. I can only 
...
"Here are some main informations you can get from me:"
df = pd.DataFrame(data)
st.dataframe(df, hide_index=True, use_container_width=True)

st.text("Project by: Rahma Amanda Mustikarini")
st.text("Final Project SanberCampus Fullstack Data Science")